...
def checkout(request, first_name, last_name, email, adress, zipcode, place, phone, amount):
    ...
    order = Order.objects.create(first_name=first_name, last_name=last_name, email=email, adress=adress, zip_code=zipcode, place=place, phone=phone, paid_amount=amount)
